<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Data Penjualan Produk</h1>
      ...
      <div class="row">
        <div class="col">
            <div class="card">
              <div class="card-body">
              <a href="<?= base_url('penjualan') ?>" class="btn btn-warning" id="tmbh">Tambah Penjualan</a>
                    ...
                    foreach($penjualan as $row):
                        ?>
                            <tr>
                                ...
                                <td><a onclick="deleteConfirm('<?php echo base_url('penjualan/deletePenjualan/'.$row->id_transaksi) ?>')" href="#" class="btn btn-danger" role="button" aria-pressed="true">Hapus</a></td>
                            </tr>
                        <?php
                    endforeach;    
                ?>
