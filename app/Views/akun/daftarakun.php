      ...
      <p>
            <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('akun') ?>" class="btn btn-warning" id="tmbh">Tambah Data Akun</a>
                    </div>
                  </div>
              </div>
            </div> 
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('akun/daftarakun') ?>"; //diisi dengan halaman ini
              ...
              var pesan = "Data dengan kode_akun <b>"
