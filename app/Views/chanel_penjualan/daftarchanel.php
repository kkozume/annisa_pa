                ...
                <?php
                    foreach($chanel_penjualan as $row):
                        ?>
                            <tr>
                                <td><?= $row['id_chanel'];?></td>
                                <td><?= $row['nama_chanel'];?></td>
                                <td>
                                  <a class="btn btn-success btn-sm" href="<?= base_url('chanel_penjualan/editchanel/'.$row['id_chanel']) ?>" role="button">
                                    <span data-feather="edit"></span>Ubah
                                  </a>
                                  <a onclick="deleteConfirm('<?php echo base_url('chanel_penjualan/deletechanel/'.$row['id_chanel']) ?>')" class="btn btn-danger btn-sm" href="#" role="button">
      ...
      <p>
            <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('chanel_penjualan') ?>" class="btn btn-warning" id="tmbh">Tambah Data Chanel Penjualan</a>
                    </div>
                  </div>
              </div>
            </div> 
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('chanel_penjualan/daftarchanel') ?>"; //diisi dengan halaman ini
              ...
              var pesan = "Data dengan id_chanel <b>"
