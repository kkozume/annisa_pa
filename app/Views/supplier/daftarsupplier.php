                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                  ...
                                  <a onclick="deleteConfirm('<?php echo base_url('supplier/deletesupplier/'.$row['id_supplier']) ?>')" class="btn btn-danger btn-sm" href="#" role="button">
      ...
      <p>
            <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('supplier') ?>" class="btn btn-warning" id="tmbh">Tambah Data supplier</a>
                    </div>
                  </div>
              </div>
            </div> 
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('supplier/daftarsupplier') ?>"; //diisi dengan halaman ini
              ...
              var pesan = "Data dengan id_supplier <b>"
