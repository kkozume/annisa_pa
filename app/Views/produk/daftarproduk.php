                    ...
                    foreach($produk as $row):
                        ?>
                            <tr>
                                ...
                                <td>
                                  <a class="btn btn-success btn-sm" href="<?= base_url('produk/editproduk/'.$row['id']) ?>" role="button">
                                    <span data-feather="edit"></span>Ubah
                                  </a>
                                  <a onclick="deleteConfirm('<?php echo base_url('produk/deleteproduk/'.$row['id']) ?>')" class="btn btn-danger btn-sm" href="#" role="button">
      ...
      <p>
            <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('produk') ?>" class="btn btn-warning" id="tmbh">Tambah Data produk</a>
                    </div>
                  </div>
              </div>
            </div>
