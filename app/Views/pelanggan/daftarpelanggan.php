                    ...
                    foreach($pelanggan as $row):
                        ?>
                            <tr>
                                ...
                                <td>
                                  <a class="btn btn-success btn-sm" href="<?= base_url('pelanggan/editpelanggan/'.$row['id_pelanggan']) ?>" role="button">
                                    <span data-feather="edit"></span>Ubah
                                  </a>
                                  <a onclick="deleteConfirm('<?php echo base_url('pelanggan/deletepelanggan/'.$row['id_pelanggan']) ?>')" class="btn btn-danger btn-sm" href="#" role="button">
      ...
      <p>
            <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('pelanggan') ?>" class="btn btn-warning" id="tmbh">Tambah Data pelanggan</a>
                    </div>
                  </div>
              </div>
            </div> 
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('pelanggan/daftarpelanggan') ?>"; //diisi dengan halaman ini
              ...
              var pesan = "Data dengan id_pelanggan <b>"
