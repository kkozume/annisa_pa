<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Pencatatan Harian</h1>
      ...
      <?php
        ...
        foreach($pencatatan_harian as $row):
          ...
          $jumlah = $row->jumlah;
          $posisi_db_kd = $row->posisi_db_kd;
          $saldo = $row->saldo;
        endforeach;
      ?>
        <div class="row">
        <?= form_open('pencatatan_harian/editpencatatanproses') ?>
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    ?>
                    <input type="text" class="form-control" id="keterangan" name="keterangan" value="<?= $keterangan?>" placeholder="Diisi dengan keterangan">
                </div>
                <div class="mb-3">
                    ...
                    ?>
                    <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?= $jumlah?>" placeholder="Diisi dengan jumlah">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    ?>
                    <input type="text" class="form-control" id="saldo" name="saldo" value="<?= $saldo?>" placeholder="Diisi dengan saldo">
                </div>
