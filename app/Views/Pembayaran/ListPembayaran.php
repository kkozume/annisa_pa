<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">DATA PEMBAYARAN GAJI PURI UTAMI</h1>
      ...
      <div class="row">
        <div class="col">
            <div class="card">
              <div class="card-body">
              <a href="<?= base_url('pembayaran') ?>" class="btn btn-warning" id="tmbh">Tambah Pembayaran Gaji</a>
                    ...
                    foreach($pembayaran as $row):
                        ?>
                            <tr>
                                ...
                                <td><a onclick="deleteConfirm('<?php echo base_url('Pembayaran/deletepembayaran/'.$row->id_transaksi) ?>')" href="#" class="btn btn-danger" role="button" aria-pressed="true">Hapus</a></td>
...
<script>
          function deleteConfirm(url){
              url2 = "<?= base_url('Pembayaran/ListPembayaran') ?>"; //diisi dengan halaman ini
              ...
              var myModal = new bootstrap.Modal(document.getElementById('deletepembayaran'), {  keyboard: false });
